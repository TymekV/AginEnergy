...
<img src="/md/Agin Energy.png" alt="logo" style={{ height:'400px', marginTop: '8px', marginBottom: '8px' }} />
...
<img src="/md/setup1.png" alt="setup" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }} />
<img src="/md/setup2.png" alt="setup" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
<img src="/md/setup3.png" alt="setup" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
<img src="/md/setup4.png" alt="setup" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
<img src="/md/price.png" alt="setup" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
...
<img src="/md/MainPage.png" alt="mainScreen" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
...
<img src="/md/devices.png" alt="devices" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>

- Ekran ustawień, w którym można zmienić cenę prądu lub hub, do którego aplikacja jest połączona

<img src="/md/settings.png" alt="settings" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
...
<img src="/md/stats.png" alt="stats" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
...
<img src="/md/addDevice.png" alt="addDevice" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
...
<img src="/md/DeviceDetails.png" alt="device" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
<img src="/md/DeviceOptions.png" alt="deviceOptions" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
<img src="/md/ColorPicker.png" alt="colorpicker" style={{ height:'500px', marginTop: '8px', marginBottom: '8px' }}/>
...
<img src="/md/AginPlugEmulator.png" alt="settings" height="400px"/>
